...
public abstract class Tree {
    ...
    public static final int GETREAL = NOT + 1;
	public static final int GETIMG = GETREAL + 1;
	public static final int TOCOMPLEX = GETIMG + 1;
	public static final int COMPL = TOCOMPLEX + 1;
	...
	public static final int ACASEEXPR = CASEEXPR + 1;
	public static final int DEFAULTEXPR = ACASEEXPR + 1;
	public static final int DOSUBSTMT = DEFAULTEXPR + 1;
   ...
   public static class SuperExpr extends Expr {
    ...
    public static class CaseExpr extends Expr {
		...
		public List<ACaseExpr> casesexpr;
		public Expr defaultexpr;

		public CaseExpr(Expr conditionexpr, List<ACaseExpr> casesexpr, Expr defaultexpr, Location loc) {
			super(CASEEXPR, loc);
		...
		public void printTo(IndentPrintWriter pw) {
			pw.println("cond");
			pw.incIndent();
			conditionexpr.printTo(pw);
			pw.println("cases");
			pw.incIndent();
			for (Expr e: casesexpr) {
				e.printTo(pw);
			}
			pw.println("default");
			pw.incIndent();
	...
	public static class ACaseExpr extends Expr {
		...
		public ACaseExpr(Literal literal, Expr expr, Location loc) {
			super(ACASEEXPR, loc);
	...
	public static class DoStmt extends Tree {
		...
		public DoStmt(DoSubStmt stmt, List<DoSubStmt> dslist, Location loc) {
			super(DOSTMT, loc);
			this.dslist = new ArrayList<DoSubStmt>();
			this.dslist.add(stmt);
			this.dslist.addAll(dslist);
		}
