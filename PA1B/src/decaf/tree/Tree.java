...
public abstract class Tree {
    ...
    public static final int GETREAL = COMPL + 1;
    ...
    public static final int SUPEREXPR = PRINT + 1;
    public static final int PRINTCOMP = SUPEREXPR + 1;
    ...
    public static class CaseExpr extends Expr {
		...
		public List<Expr> casesexpr;
		public Expr defaultexpr;

		public CaseExpr(Expr conditionexpr, List<Expr> casesexpr, Expr defaultexpr, Location loc) {
			super(CASEEXPR, loc);
	...
	public static class ACaseExpr extends Expr {
		...
		public ACaseExpr(Expr literal, Expr expr, Location loc) {
			super(ACASEEXPR, loc);
	...
	public static class DoStmt extends Tree {
		...
		public DoStmt(List<Tree> slist, Tree stmt, Location loc) {
			super(DOSTMT, loc);
			this.slist = slist;
			this.stmt = stmt;
		}
